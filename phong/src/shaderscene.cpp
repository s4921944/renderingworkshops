...
void ShaderScene::initGL() noexcept {
    ...
    shader->loadShader("MyShaderProgram","shaders/mytoon_vert.glsl","shaders/mytoon_frag.glsl");
    //shader->loadShader("MyShaderProgram","shaders/myshader_vert.glsl","shaders/myshader_frag.glsl");
...
void ShaderScene::paintGL() noexcept {
    ...
    case SHADER_COOKTORRANCE:
        ...
        //break;
    default:
        (*shader)["MyShaderProgram"]->use();
        pid = shader->getProgramID("MyShaderProgram");
        break;
    }
